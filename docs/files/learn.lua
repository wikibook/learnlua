...
x, y = bar('zaphod')  --> "zaphod nil nil"이 출력됨
...
--    오든 상관없을 것입니다.
-- 4. 'makeSound' 키는 LoudDog에서 발견할 수 있습니다. 이것은
--    LoudDog.makeSound(seymour)와 같습니다.
